...
for i = 1:endi
    ...
    for j = 1:endj
        ...
        dist_from_origin = dist_from_origin + 5;
...
%                 xlabel('Pixels')
%                 ylabel('Pixels')
%                 title('Checking if scanner is outside FOV');
...
% 
figure(3);
back_graph = heatmap(scanner_ratio12/100);
title('Ratio of Back of Scanner Visible Compared to Calculated Back Area (12mm Lens)');
...
back_graph.XDisplayLabels = CustomXLabels;
YLabels = [50:-5:-445];
% Convert each number in the array into a string
...
% Set the 'XDisplayLabels' property of the heatmap 
% object 'h' to the custom x-axis tick labels
back_graph.YDisplayLabels = CustomYLabels;
colorbar;
colormap jet;

figure(4);
front_graph = heatmap(ratio_front_heatmap12/100);
title('Ratio of Front of Scanner Compared to Total FOV (12mm Lens)');
xlabel('Distance from origin (mm)');
ylabel('Point of interest location on x-axis (mm)');
XLabels = [60:5:555];
% Convert each number in the array into a string
...
% Set the 'XDisplayLabels' property of the heatmap 
% object 'h' to the custom x-axis tick labels
front_graph.XDisplayLabels = CustomXLabels;
YLabels = [50:-5:-445];
% Convert each number in the array into a string
CustomYLabels = string(YLabels);
% Replace all but the fifth elements by spaces
...
% Set the 'XDisplayLabels' property of the heatmap 
% object 'h' to the custom x-axis tick labels
front_graph.YDisplayLabels = CustomYLabels;

colorbar;
colormap jet;

figure(5);
combined_graph=heatmap(scanner_ratio12/100.*ratio_front_heatmap12/100);
title('Combined Heat maps Showing Optimal Parameters (12mm)');
xlabel('Distance from origin (mm)');
ylabel('Point of interest location on x-axis (mm)');
XLabels = [60:5:555];
% Convert each number in the array into a string
...
% Set the 'XDisplayLabels' property of the heatmap 
% object 'h' to the custom x-axis tick labels
combined_graph.XDisplayLabels = CustomXLabels;
YLabels = [50:-5:-445];
% Convert each number in the array into a string
CustomYLabels = string(YLabels);
% Replace all but the fifth elements by spaces
...
% Set the 'XDisplayLabels' property of the heatmap 
% object 'h' to the custom x-axis tick labels
combined_graph.YDisplayLabels = CustomYLabels;
colorbar;
colormap jet;
